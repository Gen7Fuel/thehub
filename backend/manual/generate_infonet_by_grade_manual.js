...
function generatePdfReports() {
  ...
  const fuelGrades = [
    { type: 'REGULAR', fileName: 'Infonet Report by Client - Regular - BROKENHEAD COMMUNITY STORE - July 16 to 31 2026.pdf', title: 'INFONET REPORT BY CLIENT - REGULAR' },
    { type: 'DIESEL', fileName: 'Infonet Report by Client - Diesel - BROKENHEAD COMMUNITY STORE - July 16 to 31 2026.pdf', title: 'INFONET REPORT BY CLIENT - DIESEL' },
    { type: 'PREMIUM', fileName: 'Infonet Report by Client - Premium - BROKENHEAD COMMUNITY STORE - July 16 to 31 2026.pdf', title: 'INFONET REPORT BY CLIENT - PREMIUM' }
  ];
