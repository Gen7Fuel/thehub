...
//   collapsed?: boolean; // UI state for collapse
// }
...
// export function PermissionTree({ permission, onSave }: { permission: Permission, onSave: (updated: PermissionNode[], moduleName: string) => void }) {
...
//   // Helper to recursively set collapsed = true
//   const initializeCollapsed = (nodes: PermissionNode[]): PermissionNode[] => {
//     return nodes.map(node => ({
//       ...node,
//       collapsed: true, // children hidden initially
...
//         return (
//           <li key={i}>
//             <div className="flex items-center p-2 border rounded-md bg-white shadow-sm space-x-2">
...
//                 placeholder="Click to name this node"
...
//           <Button variant="outline" onClick={() => setStructure([...structure, { name: "", children: [], collapsed: false }])}>
...
//       <div className="pt-6">
//         <Button onClick={() => onSave(structure, moduleName)} className="bg-blue-600 text-white hover:bg-blue-500">
//           Save Changes
//         </Button>
//       </div>
//     </div>
