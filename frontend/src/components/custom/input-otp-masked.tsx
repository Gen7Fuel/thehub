...
export function InputOTPSlot({
  ...
  maskChar = "•",
  ...props
}: React.ComponentProps<"div"> & { index: number; masked?: boolean; maskChar?: string }) {
...
// Convenience fully masked slot
export const InputOTPHiddenSlot = (p: Omit<React.ComponentProps<typeof InputOTPSlot>, "masked">) => (
  <InputOTPSlot masked {...p} />
)