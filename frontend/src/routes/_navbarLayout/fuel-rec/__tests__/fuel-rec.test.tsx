...
describe('BOL Capture Form — fuel-rec/index.tsx', () => {
  ...
  /* TEMPORARILY DISABLED: The following tests relied on FileReader base64 mocks 
     which do not trigger when switching to client-side image compression / FormData upload.
