...
function RouteComponent() {
  ...
  return (
    <div className="px-4 space-y-4 w-full max-w-[100vw] overflow-x-hidden flex flex-col">
      ...
      `}</style>
      <div className="relative flex w-full flex-col sm:flex-row items-center justify-center gap-4 rounded cash-rec-no-print">
        <SitePicker
          value={site}
          onValueChange={(val) =>
            navigate({
        ...
        {site && data && (
          <button
            ...
            className="sm:absolute sm:right-0 px-3 py-1.5 text-sm border rounded bg-white hover:bg-gray-50"
          >
            Export PDF
          </button>
        )}
