  ...
  component: () => (
    <div className="h-full w-full flex flex-col items-center justify-center bg-slate-50/30">
      <div className="text-center animate-in fade-in zoom-in duration-300">
        ...
        <h2 className="text-xl font-black italic uppercase tracking-tighter text-slate-900">Rack Infrastructure</h2>
        <p className="text-slate-400 text-xs font-bold uppercase tracking-widest mt-1 mb-6">Select a terminal to view supply data</p>
